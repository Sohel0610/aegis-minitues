...
interface SEBIMonthlyTrendChartProps {
  data: MonthlyData[];
}
...
const chartConfig = {
  total_notifications: {
    label: "Notifications",
    color: "#E4A6CB", // Changed from #BD3861 to match BSE Alerts
  },
} satisfies ChartConfig;

const SEBIMonthlyTrendChart = ({ data }: SEBIMonthlyTrendChartProps) => {
...
export default SEBIMonthlyTrendChart;