      ...
      <RBIAnalysisDashboardLayout>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <Loader2 className="h-8 w-8 animate-spin mx-auto mb-4" style={{ color: "#75479C" }} />
          ...
          <Card className="border-0 shadow-none bg-transparent">
            <CardHeader className="px-0 pb-4">
              <div className="flex items-center gap-3 mb-2">
                <Mail className="h-8 w-8" style={{ color: "#75479C" }} />
                <CardTitle className="text-2xl sm:text-3xl lg:text-4xl font-bold " style={{ color: "#000000" }}>
                  EMAIL DATA
                </CardTitle>
                {/* Admin mode indicator */}
                {isAdminMode && (
                  <Badge variant="outline" style={{ color: '#75479C', borderColor: '#75479C', background: 'transparent' }}>
            ...
            <CardContent className="px-0 py-0">
              ...
              {emailData.length > 0 ? (
                ...
                <div className="text-center py-8 border rounded-md" style={{ borderColor: '#000000' }}>
                  <Mail className="h-12 w-12 mx-auto mb-4" style={{ color: '#75479C' }} />
