"""
Database Models for Minutes Chatbot

All tables are created in the 'minutes_chatbot_db' schema
under the 'minutes_preparation_system' database.
"""
...
class User(Base):
    ...
    __tablename__ = "users"
    #__table_args__ = {'schema': 'minutes_chatbot_db'}  # Disabled for SQLite compatibility
...
class Embedding(Base):
    ...
    embedding_vector = Column(JSON)  # Store as JSON for SQLite, list of floats
    created_at = Column(DateTime, default=datetime.utcnow)
