...
print(f"[DEBUG] API_URL loaded: {bool(API_URL)}", flush=True)
print(f"[DEBUG] USERNAME loaded: {bool(USERNAME)}", flush=True)
print(f"[DEBUG] PASSWORD loaded: {bool(PASSWORD)}", flush=True)
