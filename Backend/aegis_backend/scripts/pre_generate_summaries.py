...
def pre_generate_all_summaries():
    """Pre-generate summaries for all disclosure documents"""
    try:
        ...
        print("\nFinished pre-generating all summaries!")
        
    except Exception as e:
        print(f"Error pre-generating summaries: {e}")
        import traceback
        traceback.print_exc()

if __name__ == "__main__":
    pre_generate_all_summaries()