...
from .models import Base, User, Agenda, Decision, ActionItem, Attendee, Document, ChatHistory, Embedding, SessionSummary, UserPreference, ConversationEntity
...
if settings.DATABASE_URL.startswith("sqlite"):
    ...
    # Ensure local directory exists for SQLite db file
...
def init_db():
    ...
    _ = (User, Agenda, Decision, ActionItem, Attendee, Document, ChatHistory, Embedding, SessionSummary, UserPreference, ConversationEntity)
